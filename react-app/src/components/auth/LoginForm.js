            ...
            <div className="login-right-container">
              <div className="login-right-container-child">
                ...
                {errors.map((error, ind) => (
                  <div className="login-error-messages" key={ind}>
                    {error}
                  </div>
                ))}
              ...
              <div className="login-right-container-bottom-part">
                <div className="login-right-container-bottom-part-child">
                  <p className="no-account-text">
                    ...
                    <NavLink exact to="/signup" className="signup-button">
            ...
            <div className="about-container-child">
              <div className="about-navlink-container">
                <a
                  ...
                  target="_blank"
                  href="https://github.com/HugoMazuera"
                  rel="noreferrer"
                >
                  <div className="our-names">Hugo Mazuera</div>
                </a>
              </div>
            </div>
          </div>
